...
import {searchQuote} from '../../redux/reducers/quotes';
...
class Quotes extends PureComponent {
  ...
  componentDidMount = () => {
    console.log('this.props', this.props.online);
    this.init();
  ...
  init = () => {
    setTimeout(() => {
      console.log('this.props.online', this.props.online);
      const {online} = this.props;
      if (online) {
        this.setState({showLoading: true});
        this.props
          ...
          {!searchResult ? (
            <>
              <CardWithIcon
                ...
                onPress={() =>
                  this.openScreen('StatusQuotes', pendingItems, 'PENDING')
                }
              ...
              <CardWithIcon
                ...
                onPress={() =>
                  this.openScreen('StatusQuotes', acceptedItems, 'ACCEPTED')
                }
                amountStyle={styles.amountTextStyle}
                statusStyle={styles.statusTextStyle}
              />
              <CardWithIcon
                ...
                onPress={() =>
                  this.openScreen('StatusQuotes', rejectedItems, 'REJECTED')
                }
                amountStyle={styles.amountTextStyle}
                statusStyle={styles.statusTextStyle}
              />
...
const mapDispatch = ({userData: {getQuotesList}}) => ({
  getQuotesList: (obj) => getQuotesList(obj),
});

export default connect(mapStateToProps, mapDispatch)(Quotes);
