...
export default class AddOrderQuote extends PureComponent {
  ...
  return (<SafeAreaView style={commonStyles.ketboardAvoidingContainer}>
        ...
        <InputBox placeHolder="" boxStyle={styles.inputBoxStyle} inputStyle={styles.input} onChangeText={value => this.setState({ orderId: value })}/>

         <View style={commonStyles.space}>
        <Text style={styles.labelText}>Order Title</Text>
        <InputBox placeHolder="" boxStyle={styles.inputBoxStyle} inputStyle={styles.input} onChangeText={value => this.setState({ orderTitle: value })}/>
        </View>
    ...
    <ExpandCollapseLayout title="+ Billing & Shopping Address">
    </ExpandCollapseLayout>
