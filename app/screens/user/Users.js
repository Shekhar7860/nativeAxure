 ...
 openQuote = () => {
  ...
  listItem = (item, index) => {
	...
	return (<SafeAreaView style={commonStyles.ketboardAvoidingContainer}>
        <Header  navigation={this.props.navigation} rightImage={USER} title="USERS"/>
        ...
        <CardWithIcon color={APP_MAIN_GREEN} count={''} status={''} amount={'2 Active'} amountStyle={styles.amountStyle} onPress={this.onClickListen}/>
        <CardWithIcon color={APP_MAIN_COLOR} count={''} status={''} amount={'1 InActive'}  amountStyle={styles.amountStyle}  onPress={this.onClickListen}/>
