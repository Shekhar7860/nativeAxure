...
export const createGroupChannel = (inviteUserIdList, name) => {
  return dispatch => {
    return sbCreateGroupChannel(inviteUserIdList, name)
      .then(channel => {
        dispatch({
      ...
      .catch(error => {
        ...
        dispatch({ type: CREATE_GROUP_CHANNEL_FAIL,  channel: channel });
      });
  };
};
