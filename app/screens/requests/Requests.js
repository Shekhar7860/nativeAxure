...
import {APP_LIGHT_BLUE_COLOR, DARK_GRAY,  ORANGE_COLOR, LIGHTEST_GRAY,FOREST_COLOR,  SEMI_TRANSPARENT,WHITE,DARK_BLUE, LINE_COLOR, NOTIFICATION_COUNT_BG_COLOR, APP_MAIN_GREEN, APP_MAIN_BLUE, APP_MAIN_COLOR} from '../../constants/colors'
  ...
  listItem = (item, index) => {
    return (
      <TouchableOpacity style={styles.rowItem} >
          ...
          { index === 0 ?
           ...
           : null }
          <View style={ index===0 ? styles.cardRow : styles.cardRowWithoutButton}>
          <View style={styles.roundBackground}/>
          <View style={{width: '5%'}}/> 
          <View style={{width: '10%'}}> 
          <Image source={PHONE} style={{...commonStyles.smallIcon, marginTop : moderateScale(5)}}/>
          </View>
          <View style={{width : '40%'}}>
	...
	return (<SafeAreaView style={{ ...commonStyles.ketboardAvoidingContainer, backgroundColor : LIGHTEST_GRAY}}>
        ...
        <ActionButton buttonColor={APP_MAIN_GREEN} spacing={moderateScale(5)}>
          <ActionButton.Item buttonColor={FOREST_COLOR} title="New Contact" textContainerStyle={styles.buttonContainer} textStyle={styles.textStyle} onPress={() => console.log("notes tapped!")}>
            <Icon name="md-create" style={styles.actionButtonIcon} />
          </ActionButton.Item>
          <ActionButton.Item buttonColor={FOREST_COLOR} textContainerStyle={styles.buttonContainer}  title="New email" textStyle={styles.textStyle}  onPress={() => {}}>
            <Icon name="md-notifications-off" style={styles.actionButtonIcon} />
          </ActionButton.Item>
          <ActionButton.Item buttonColor={FOREST_COLOR} textContainerStyle={styles.buttonContainer}  title="New ticket"  textStyle={styles.textStyle}  onPress={() => {}}>
