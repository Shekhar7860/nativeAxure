...
export default class AddOrderQuote extends PureComponent {
  ...
  return (<SafeAreaView style={commonStyles.ketboardAvoidingContainer}>
        <Header navigation={this.props.navigation} rightImage={USER} title="USERS" leftImage={BACK} />
        ...
        <InputBox placeHolder="" boxStyle={styles.inputBoxStyle} inputStyle={styles.input} onChangeText={value => this.setState({ firstName: value })}/>
        </View>

         <View style={commonStyles.space}>
        <Text style={styles.labelText}>Surname</Text>
        <InputBox placeHolder="" boxStyle={styles.inputBoxStyle} inputStyle={styles.input} onChangeText={value => this.setState({ surname: value })}/>
        </View>

        <View style={commonStyles.space}>
        <Text style={styles.labelText}>Group</Text>
        <InputBox placeHolder="" boxStyle={styles.inputBoxStyle} inputStyle={styles.input} onChangeText={value => this.setState({ group: value })}/>
        </View>

        <View style={commonStyles.space}>
        <Text style={styles.labelText}>Partner</Text>
        <InputBox placeHolder="" boxStyle={styles.inputBoxStyle} inputStyle={styles.input} onChangeText={value => this.setState({ partner: value })}/>
        </View>

        <View style={commonStyles.space}>
        <Text style={{...styles.labelText, fontWeight : 'bold'}}>Password</Text>
        </View>

          <View style={commonStyles.space}>
         <Text style={styles.labelText}>New  Password</Text>
        <InputBox placeHolder="" boxStyle={styles.inputBoxStyle} inputStyle={styles.input} onChangeText={value => this.setState({ newPassword: value })}/>
        </View>
         <View style={commonStyles.space}>
        <Text style={styles.labelText}>Confirm Password</Text>
        <InputBox placeHolder="" boxStyle={styles.inputBoxStyle} inputStyle={styles.input} onChangeText={value => this.setState({ confirmPassword: value })}/>
      </View>
