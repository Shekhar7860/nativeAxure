...
import {APP_LIGHT_BLUE_COLOR, GRAY, SEMI_TRANSPARENT,WHITE,DARK_BLUE, NOTIFICATION_COUNT_BG_COLOR, APP_MAIN_GREEN, APP_MAIN_BLUE, APP_MAIN_COLOR} from '../../constants/colors'
...
export default class UploadOrderWithFile extends PureComponent {
  ...
  return (<SafeAreaView style={commonStyles.ketboardAvoidingContainer}>
        ...
        <InputBox placeHolder="" boxStyle={styles.inputBoxStyle} inputStyle={styles.input} onChangeText={value => this.setState({ name: value })}/>
        ...
        <View style={commonStyles.space}>
        <Text style={{...styles.labelText, color : GRAY}}>File Upload</Text>
        <Text style={styles.uploadText}>Upload one or more files</Text>
        <ButtonDefault style={{backgroundColor : 'white', borderRadius : moderateScale(0), marginTop : moderateScale(10)}} textStyle={{color : GRAY}}>Upload</ButtonDefault>
        </View>
